...
public class BaseRestController<T> {
    ...
    /**
     * Méthode qui récupère la liste des Bailleurs
     *
     * @return
     */
    @GET//Signifie que c est une methode de lecture
    ...
    /**
     * Méthode qui récupere un bailleur grace a son id
     *
     * @param id
     * @return
     */
    ...
    /**
     * Methode qui met a jour un bailleur
     *
     * @param bailleur
     * @return
     */
    ...
    /**
     * Méthode qui récupère un bailleur grace a son id et affiche une répone
     * partielle en fonction des attributs lister par l'utilisateur
     *
     * @param id
     * @param fields
     * @return
    ...
    /**
     * Méthode qui verifie si une chaine de caratere fais partir des élements
     * d'un tableau
     *
     * @param fields
     * @param field
    ...
    /**
     * Méthode qui récupère la liste des Bailleurs et qui trie sur ce dernier
     *
     * @param attribut
     * @return
     */
    ...
    /**
     * Méthode qui récupère la liste des Bailleurs et applique une pagination
     * sur le résultats retourner
     *
     * @param offset
     * @param limit
     * @return
    ...
    /**
     * Méthode qui permet de fait une recherche a partir d'une ou pluisieur
     * champs de Bailleur
     *
     * @param attribut
     * @param value
