...
public class IndicateurPerformanceRestController {
    ...
    private final IndicateurPerformanceRepository mysql = new IndicateurPerformanceRepository("punit-mysql");
...
//    @Path("/")
//    @Produces(MediaType.APPLICATION_JSON)
//    public Response delete(IndicateurPerformance indicateurPerformance) throws SQLException {
